...
PROGRAMS = [
 ...
 },
 {
  ...
  "meta": "Relationship management training for retail and corporate bankers — trusted-advisor conversations, portfolio growth and credit judgment, on your own products.",
 ...
 },
 {
  ...
  "audience": [
    ...
    ("Branch and contact-center leadership", "قيادات الفروع ومراكز الاتصال"),
 ...
 },
 {
  ...
  "modules": [
    ...
    ("Credit and asset quality review", "File reviews, classification and provisioning judgment.",
    ...
    ("Supervisory judgment cases", "Senior practitioners walk through real dilemmas phase by phase.",
 ...
 },
 {
  ...
  "meta": "Corporate credit analysis training for banks — cashflow-based lending judgment, structuring and credit writing, taught by practitioners on regional cases.",
...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'sha256-/x7W7R75k8Roq0WaVRQX9blP4OufE5xbAdzklGxsgpw='; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data:; connect-src 'self'; object-src 'none'; base-uri 'self'; form-action 'self'; upgrade-insecure-requests">
